# I'm Jagoda 👋 Welcome on my Github profile

A graduate of first and second degree studies in the field of Computer Science 🎓

### Projects from studies

Engineering Thesis: "Visualization of data and results of pedestrian traffic distribution analysis in public transport interchanges" 
...
[📂](https://github.com/gajdzinska/Interface_Based_On_The_Head_Movements_And_Facial_Expressions.git) Master Thesis: "Study of user interaction in the interface based on head movements and facial expressions" 
...
<!--
**gajdzinska/gajdzinska** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
